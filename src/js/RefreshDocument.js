...
* @constructor
*/
mindmaps.RefreshDocumentView = function () {
...
/**
* Creates a new RefreshDocumentPresenter. The presenter can store documents in the
...
*/
mindmaps.RefreshDocumentPresenter = function (eventBus, mindmapModel, view, autosaveController, filePicker) {
    ...
    */
    ...
    this.go = function () {
        ...
        if (view.fileContentsRequested) {
            ...
            alert("There is an error refreshing the data. Please try again.");
        }
    };
};
