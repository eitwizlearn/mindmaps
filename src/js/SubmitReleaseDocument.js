/**
* Creates a new SubmitReleaseDocumentView. This view renders a dialog where the user can
* save the mind map.
* 
* @constructor
*/
mindmaps.SubmitReleaseDocumentView = function () {
...
/**
* Creates a new SubmitReleaseDocumentPresenter. The presenter can store documents in the
...
*/
mindmaps.SubmitReleaseDocumentPresenter = function (eventBus, mindmapModel, view) {
    ...
    this.go = function () {
        ...
        if (view.fileContentsRequested) {
            SubmitMindMap(view.fileContentsRequested(),"TRUE");
        }
        else {
