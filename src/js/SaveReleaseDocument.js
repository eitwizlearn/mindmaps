/**
* Creates a new SaveReleaseDocumentView. This view renders a dialog where the user can
* save the mind map.
* 
* @constructor
*/
mindmaps.SaveReleaseDocumentView = function () {
...
/**
* Creates a new SaveReleaseDocumentPresenter. The presenter can store documents in the
* local storage or to a hard disk.
* 
* @constructor
* @param {mindmaps.EventBus} eventBus
* @param {mindmaps.MindMapModel} mindmapModel
* @param {mindmaps.SaveReleaseDocumentView} view
* @param {mindmaps.AutoSaveController} autosaveController
* @param {mindmaps.FilePicker} filePicker
*/
mindmaps.SaveReleaseDocumentPresenter = function (eventBus, mindmapModel, view, autosaveController, filePicker) {
    ...
    */
    ...
    this.go = function () {
        ...
        if (view.fileContentsRequested) {
            SaveMindMap(view.fileContentsRequested(),"TRUE");
        }
        else {
            alert("There is an error getting the data to save. Please try again.");
        }
    };
};
