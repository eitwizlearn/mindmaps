 ...
 * @constructor
 */
mindmaps.ExportSaveMapView = function () {
    var self = this;
 ...
 */
mindmaps.ExportSaveMapPresenter = function(eventBus, mindmapModel, view) {
  ...
  this.go = function() {
      ...
      var imgStr = renderer.getImageData(mindmapModel.getDocument());
      
      SaveMindMapImage(imgStr);
